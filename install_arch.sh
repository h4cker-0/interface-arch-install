...
function install_arch(){
	...
	mkdir ~/.config/kitty/ && cd ~/.config/kitty/ && mv ~/repos/interface-arch-install/kitty.conf . && mv ~/repos/interface-arch-install/color.ini . && sudo cp ~/repos/interface-arch-install/rc.lua ~/.config/awesome/
